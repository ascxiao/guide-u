...
class IncidentReportViewModel extends ChangeNotifier {
  IncidentReportViewModel({ReportingService? service})
  ...
  List<IncidentReportItem> _history = [];
  ...
  List<IncidentReportItem> get history => _history;
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _history = await _service.fetchMyIncidentReports();
    } catch (e) {
      _error = e.toString();
    } finally {
      _loading = false;
  ...
  Future<bool> submit({
    ...
    try {
      ...
      _images.clear();
      _success = 'Incident report submitted successfully.';
      _history = await _service.fetchMyIncidentReports();
      return true;
    } catch (e) {
      _error = e.toString();
