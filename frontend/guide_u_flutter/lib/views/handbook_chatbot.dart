...
class _HandbookChatbotBody extends StatefulWidget {
  ...
  @override
  State<_HandbookChatbotBody> createState() =>
      _HandbookChatbotBodyState();
}

class _HandbookChatbotBodyState
    extends State<_HandbookChatbotBody> {
  ...
  void _send() {
    final viewModel =
        Provider.of<HandbookChatbotViewModel>(context,
            listen: false);
